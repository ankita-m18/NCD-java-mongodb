...
<body>
	<form name="NCD" method="post" action="resultServlet">
		<table align="center" border="1">
			<tr>
				<th colspan="4" style="background-color: rgb(52, 173, 52)">NCD
					Risk Assessment Checklist</th>
			</tr>
			...
			<tr>
				<td rowspan="3">2. Do you smoke or Consume smokeless product
					like Gutka or Khaini?</td>
			...
			<tr>
				<td rowspan="2">5. Do you undertake any physical activities for
					a minimum of 150 minutes a week?</td>
			...
			<tr>
				<td rowspan="2">6. Do you have a family history (any one of
					your parents or siblings) of high blood pressure, diabetes and
					heart disease?</td>
				<td colspan="2">No</td>
			...
			<tr style="text-align: right">
				<th rowspan="2" style="background-color: lightpink" align="left">Total
					Score: (Click on Calculate)</th>
				<td colspan="4" style="background-color: lightpink"><input
					type="submit" value="Calculate"></td>
			</tr>
